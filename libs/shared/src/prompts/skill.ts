import { ActivitySummary } from '../types/github';

export const SKILL_INFERENCE_PROMPT = (activitySummary: ActivitySummary) => `You are analyzing a developer's GitHub activity to infer their technical skills.
