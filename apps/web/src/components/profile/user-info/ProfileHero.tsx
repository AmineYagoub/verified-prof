...
export const ProfileHero = ({
  ...
  return (
    <section className="relative flex flex-col lg:flex-row items-center gap-4 max-w-4xl mx-auto w-full">
      {isDashboard ? (
        ...
        <figure className="relative group">
          <div
            className="w-[300px] h-[300px] rounded-full overflow-hidden relative ring-4 ring-primary/20 transition-all hover:ring-primary/40"
            onClick={handleAvatarClick}
            data-tip="Click to change avatar"
          >
            {currentAvatar ? (
      ...
      <header className="flex flex-col">
        <h1 className="text-7xl font-bold text-left mb-4">{userName}</h1>
        <p className="text-lg text-base-content/70 leading-relaxed max-w-2xl text-left">
          {bio}
        </p>
        ...
        <div className="text-center mt-8">
          ...
          >
            ...
            <span className="hidden font-semibold inline-block mx-8">
              Talk to vTwin AI
            </span>
          </button>
        </div>
